...
public class TestRedis {
	public static void main(String[] args) {
		...
		// D:\workspace\Test\src\main\resources\applicationContext-redis.xml
		// 所以 classpath是定位到 resources 目录下
		...
		// Thread.sleep(5000);
		 Map<String,Object> map=new HashMap<>(); map.put("name", "王赛超");
